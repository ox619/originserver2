...
import (
	...
	"originserver2/gateservice/tcpmodule"
	"originserver2/gateservice/wsmodule"
	"time"
...
func (gate *GateService) OnInit() error {
	gate.pbRawProcessor.SetConnectedHandler(gate.msgRouter.OnConnected)
	gate.pbRawProcessor.SetDisConnectedHandler(gate.msgRouter.OnDisconnected)
	gate.pbRawProcessor.SetRawMsgHandler(gate.msgRouter.RouterMessage)
